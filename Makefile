...
$(TARGET).elf.tmp: src/main.c src/microapp.c src/Arduino.c src/Wire.cpp src/Serial.cpp src/ArduinoBLE.cpp src/BleUtils.cpp src/BleDevice.cpp src/Mesh.cpp src/Presence.cpp src/PowerUsage.cpp $(SHARED_PATH)/ipc/cs_IpcRamData.c $(TARGET).c
...
$(TARGET).elf: src/main.c src/microapp.c src/Arduino.c src/Wire.cpp src/Serial.cpp src/ArduinoBLE.cpp src/BleUtils.cpp src/BleDevice.cpp src/Mesh.cpp src/Presence.cpp src/PowerUsage.cpp $(SHARED_PATH)/ipc/cs_IpcRamData.c $(TARGET).c include/microapp_header_symbols.ld
